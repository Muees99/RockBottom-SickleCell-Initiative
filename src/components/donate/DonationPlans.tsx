...
//               <div
//                 key={idx}
//                 className={`${plan.bg} border rounded-xl p-6 hover:shadow-md transition text-left`}
//               >
...
//         <div className="mt-8">
//           <button className="bg-[#2F7889] text-white px-6 py-3 rounded-full hover:bg-[#25616f] transition">
//             Make Donation
//           </button>
//         </div>
//       </div>
